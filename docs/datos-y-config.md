...
| Destinatarios | Ninguno: el harness no envía datos a terceros; la única salida de red son las llamadas que el usuario dispara hacia sus propios proveedores de modelos |
